...
omarchy_command_test && macos_mapping_test && macos_cask_mapping_test && macos_zap_plugin_status_test && wsl_zap_plugin_status_test && wsl_zap_plugin_install_test && wsl_batcat_test && zap_argument_test && omarchy_failure_test && pacman_fallback_test
